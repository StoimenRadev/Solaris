...
{
    [Header("Orbit Parameters — Mercury")]
    public float a = 2000f;                        // semi-major axis
    [Range(0f, 0.99f)]
    public float eccentricity = 0.2056f;           // Mercury eccentricity
    public float planetYearLength = 87.969f;       // Mercury year in Earth days
    public float startTheta = 4.10f + Mathf.PI;    // approximate Feb 19, 2026
