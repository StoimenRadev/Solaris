...
[ExecuteAlways]
public class OrbitPathJupiter : MonoBehaviour
{
    [Header("Orbit Parameters — Jupiter")]
    public float a = 5000f;                        // semi-major axis
    [Range(0f, 0.99f)]
    public float eccentricity = 0.0489f;           // Mercury eccentricity
    public float planetYearLength = 4332.589f;       // Mercury year in Earth days
    public float startTheta = 0.85f + Mathf.PI;    // approximate Feb 19, 2026
