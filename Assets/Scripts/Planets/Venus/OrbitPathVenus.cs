...
[ExecuteAlways]
public class OrbitPathVenus : MonoBehaviour
{
    [Header("Orbit Parameters — Venus")]
    public float a = 2500f;                        // semi-major axis
    [Range(0f, 0.99f)]
    public float eccentricity = 0.0068f;           // Mercury eccentricity
    public float planetYearLength = 224.701f;       // Mercury year in Earth days
    public float startTheta = 3.25f + Mathf.PI;    // approximate Feb 19, 2026
