...
{
    [Header("Orbit Parameters — Neptune")]
    public float a = 8000f;                        // semi-major axis
    [Range(0f, 0.99f)]
    public float eccentricity = 0.0113f;           // Neptune eccentricity
    public float planetYearLength = 60189f;       // Neptune year in Earth days
    public float startTheta = 1.60f;    // approximate Feb 19, 2026
