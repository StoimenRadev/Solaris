...
[ExecuteAlways]
public class OrbitPathUranus : MonoBehaviour
{
    [Header("Orbit Parameters — Uranus")]
    public float a = 7000f;                        // semi-major axis
    [Range(0f, 0.99f)]
    public float eccentricity = 0.0457f;           // Uranus eccentricity
    public float planetYearLength = 30685.4f;       // Uranus year in Earth days
    public float startTheta = 2.80f;    // approximate Feb 19, 2026
